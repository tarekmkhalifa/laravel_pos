    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-dashboard"></i>@lang('site.edit_product')</li>
            </ol>
        </section>
                    ...
                    <form action="{{ route('dashboard.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        @foreach (config('translatable.locales') as $locale)
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="{{ $locale }}[description]" class="form-control ckeditor" rows="3">{{$product->translate($locale)->description}}</textarea>
                            </div>
                        @endforeach
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <img src="{{ asset("uploads/product_images/$product->image") }}" style="width: 80px"
